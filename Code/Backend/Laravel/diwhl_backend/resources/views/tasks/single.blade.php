    ...
    <main class="container mx-auto p-4 mt-6">
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-start mb-6">
                ...
                <span class="inline-block bg-yellow-100 text-yellow-800 text-sm px-3 py-1 rounded-full">Due: 2023-06-15</span>
            </div>
            ...
            <div class="mb-6">
                ...
                <ul class="text-gray-600 space-y-2">
                    <li class="flex items-center">
                        ...
                        Status: <span class="font-medium ml-1"> {{ $task->is_completed }} </span>
                    </li>
                    <li class="flex items-center">
                        <svg class="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        Due Date: <span class="font-medium ml-1"> {{ $task->has_due_date }} </span>
                    </li>
                    <li class="flex items-center">
